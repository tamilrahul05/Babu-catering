...
const DishCard = ({ dish, index, isSelected, toggleItem }) => {
 ...
 isSelected 
 ? 'border-green-500 shadow-[0_20px_50px_rgba(0,177,79,0.2)] bg-green-500/5' 
 ...
 initial={{ scale: 0 }} 
 animate={{ scale: 1 }} 
 className="absolute top-4 right-4 bg-green-500 text-black p-2 rounded-full shadow-xl z-10"
 >
 ...
 isSelected ? 'text-green-500' : 'text-zinc-500'
 }`}>
...
const BuildPlate = ({ categoryId, dishDatabase, selectedItems, toggleItem, setShowLeafPreview }) => {
 ...
 Pick Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-green-500 to-green-600 italic">{categoryId}</span> Dishes
 </h1>
