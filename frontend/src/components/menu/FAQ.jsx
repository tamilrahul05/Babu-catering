...
const FAQ = () => {
 ...
 <span className="text-green-500 font-bold tracking-[0.3em] uppercase text-xs block mb-4">Common Inquiries</span>
 <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-green-500 to-green-600 italic">Questions</span></h2>
 </div>
