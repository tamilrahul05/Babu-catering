...
const MenuHero = () => {
 ...
 >
 <span className="inline-block py-1.5 px-6 rounded-full bg-green-500/10 border border-green-500/20 text-green-500 text-xs font-bold tracking-[0.3em] uppercase mb-8 ">
 Culinary Excellence
 </span>
 <h1 className="text-5xl md:text-7xl font-black text-white mb-6">
 Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-green-500 to-green-600 italic">Menu</span> Collection
 </h1>
