...
const Tradition = () => {
 ...
 <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-green-500/5 to-transparent skew-x-12 transform translate-x-32 pointer-events-none"></div>
 <div className="absolute -bottom-64 -left-64 w-[500px] h-[500px] bg-green-500/5 rounded-full -[120px] pointer-events-none"></div>
 
 <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-20 relative z-10">
 <div className="lg:w-1/2">
 <motion.span 
 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} 
 className="inline-block py-1.5 px-6 rounded-full bg-green-500/10 border border-green-500/20 text-green-500 font-bold tracking-[0.3em] uppercase text-xs mb-8 "
 >
 ...
 >
 A Legacy of <br />
 <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-green-500 to-green-600 italic">Authentic Taste</span>
 </motion.h2>
 <motion.p 
 ...
 >
 <div className="w-10 h-10 rounded-xl bg-green-500/10 text-green-500 flex items-center justify-center border border-green-500/20 transition-all duration-300 shadow-[0_0_15px_rgba(0,177,79,0.1)]">
 ...
 <Link to="/booking">
 <button className="px-10 py-5 bg-gradient-to-r from-green-400 to-green-600 text-black font-black text-lg rounded-sm transition-all duration-300 border border-green-300">
