...
const PHOTO_GALLERY = [
 ...
 { id: 4, category: 'Food', title: 'Interactive Dessert nitrogen station', img: 'https://images.unsplash.com/photo-1501443762994-82bd5dabb892?w=800' },
...
const Gallery = () => {
 ...
 activeMode === 'Photos' 
 ? 'bg-gradient-to-br from-[#0DCD6A] to-[#39E18B] text-[#676767] border-transparent shadow-lg hover:scale-102' 
 ...
 activeFilter === filter 
 ? 'border-[#0DCD6A] text-[#0DCD6A] bg-[#0DCD6A]/5' 
 ...
 className="group relative rounded-[2.5rem] overflow-hidden border border-zinc-800 bg-zinc-900/60 cursor-pointer shadow-lg hover:border-green-500/30 transition-all duration-500 h-[280px] md:h-[320px]"
 >
 <img 
 src={item.img} 
 alt={item.title} 
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent group-hover: transition-all duration-500 flex flex-col justify-end p-6">
 <span className="text-[#0DCD6A] text-[10px] font-black uppercase tracking-widest mb-1.5">{item.category}</span>
 ...
 <Maximize2 size={10} /> Zoom Platter
 </span>
 </div>
 {/* Category Pill */}
 <div className="absolute top-4 left-4 bg-zinc-950/80 px-3.5 py-1.5 rounded-full text-[9px] font-black text-green-500 tracking-wider uppercase border border-white/5 shadow-md group-hover: transition-opacity">
 {item.category}
 </div>
 </div>
 ))}
 ...
 <div 
 key={i}
 className="group bg-zinc-900/60 rounded-[2.5rem] p-5 border border-zinc-800 transition-all duration-500 flex flex-col hover:border-green-500/30 hover:shadow-2xl ring-1 ring-white/5"
 >
