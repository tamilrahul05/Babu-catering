...
const AppContent = () => {
 ...
 <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-zinc-900 text-white text-sm px-4 py-2 rounded-xl group-hover: transition-opacity whitespace-nowrap pointer-events-none border border-zinc-800 shadow-xl">
 Chat with us
 </span>
 </a>
 </div>
