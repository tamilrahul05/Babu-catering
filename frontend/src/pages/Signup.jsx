...
const Signup = () => {
 ...
 <h2 className="text-4xl md:text-[2.5rem] font-extrabold text-white tracking-tight mb-2">Create <span className="text-green-500">Account</span></h2>
