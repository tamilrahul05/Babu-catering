...
const Admin = () => {
 ...
 <div>
 <span className="text-green-500 font-bold tracking-[0.3em] uppercase text-xs block mb-4">Command Center</span>
 <h1 className="text-4xl md:text-5xl font-black text-white">Admin <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-green-600 italic">Dashboard</span></h1>
 </div>
 <div className="relative">
 <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500" size={18} />
 <input type="text" placeholder="Search Bookings..." className="bg-zinc-900 border border-zinc-800 text-white rounded-full py-3 pl-12 pr-6 focus:border-green-500 focus:outline-none w-64 md:w-80" />
 </div>
 </div>
 ...
 <td className="px-6 py-6">
 <div className="text-green-500 font-bold">{new Date(booking.event_date).toLocaleDateString()}</div>
